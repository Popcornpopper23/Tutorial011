...
function setupPuzzle() {
   /* Match all of the data cells in gthe puzzle*/
   puzzleCells = document.querySelectorAll("table#hanjieGrid td");

   /* Set the inital color of each cell to gold*/ 
   for (var i = 0; i < puzzleCells.length; i++) {
      puzzleCells[i].style.backgroundColor = "rgb(233, 207, 29)";
      // set the cell backgroud color in response to the mousedown event
   ...
   var empty = document.querySelectorAll("table#hanjieGrid td.filled");
...
function setBackground(e) {
   ...
   if (e.shiftKey) {
      ...
      cursorType = "url(../img/jpf_cross.png), crosshair";
   } else {
